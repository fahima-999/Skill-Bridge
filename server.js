...
// Retain a clear response for older clients that still call the former route.
app.post('/api/applications/:id/send-email', async (req, res) => {
    return res.status(410).json({ success: false, message: 'Email delivery is handled by EmailJS in the recruiter browser.' });
});
